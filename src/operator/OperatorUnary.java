...
public class OperatorUnary {
    public static void main(String[] args) {
        ...
        i++;                    //karena i tadinya sudah bernilai 1 maka sekarang  ditambah 1 lagi jadi 2
        System.out.println(i);   //tuhkan betul nilainya 2
        i=i+1;                  //bisa dilihat i++ samadengan i = i+1
